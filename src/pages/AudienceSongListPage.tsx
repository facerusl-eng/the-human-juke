...
function AudienceSongListPage() {
  ...
  const copy = audienceLocale === 'da'
    ...
    ? {
        ...
        chooseRequest: 'skrolladu og veldu osk.',
        loadingSongs: 'Hle dur log...',
        hostPlays: 'Vardstjorinn spilar - thu velur lagid',
        youSing: 'Thu ferd upp a svid og syngur sjalf/ur',
        songs: 'log',
        searchSongs: 'Leita i logum',
        searchPlaceholder: 'Leita eftir lagatitli eda flytjanda',
        availableSuffix: 'tiltaek',
        karaokeSongsLabel: 'Karaoke log',
        jukeboxSongsLabel: 'Human Jukebox log',
        iSing: 'Eg syng',
        explicit: 'Explisit',
        allMatchingQueued: 'Oll samsvarandi log eru thegar i ko.',
        noSongsAssigned: 'Engin log eru tength thetta gigg enn.',
        chooseWhoSings: 'Veldu hver syngur',
        selected: 'Valid',
        untitledSong: 'Lag an titils',
        ...
        karaokeConfirmAbort: 'Nei, kannski ekki.',
        performerSings: 'Flytjandinn syngur lagid',
        iWantToSing: '🎤 Eg vil syngja lagid',
        cancel: 'Haetta vid',
        unableToLoadSongs: 'Get ekki hladid lagavali nuna. Reyndu aftur.',
        unableToAddRequest: 'Get ekki baett vid thessari osk nuna.',
      }
    : {
        back: 'Back',
        eyebrow: 'Song List',
