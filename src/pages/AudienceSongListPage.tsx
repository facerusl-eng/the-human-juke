...
function AudienceSongListPage() {
  ...
  const copy = audienceLocale === 'da'
    ? {
        ...
        chooseRequest: 'scroll ned og vælg dit ønske.',
        loadingSongs: 'Indlæser sange...',
        hostPlays: 'Værten spiller - du vælger sangen',
        youSing: 'Du går på scenen og synger den selv',
        songs: 'sange',
        ...
        iSing: 'Jeg synger',
        explicit: 'Eksplicit',
        allMatchingQueued: 'Alle matchende sange er allerede i køen.',
        ...
        karaokeConfirmBody: 'Hvis du fortsætter, melder du dig frivilligt — ja, dig personligt — til at gå på scenen og synge denne sang foran alle. Værten kalder dit navn op. Folk vil kigge. Der er ingen vej tilbage. Det bliver helt fantastisk (eller i det mindste uforglemmeligt).',
