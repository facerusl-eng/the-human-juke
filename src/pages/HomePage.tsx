...
const COPY = {
  en: {
    ...
    subtitle: 'The Human Jukebox lets the crowd request songs, sing along in karaoke mode, and vote the queue live — all on a shared screen my whole venue can see.',
    ...
    how: [
      { icon: '📅', label: 'You book the show', copy: 'One message is all it takes. I arrive set up and ready — no gear, no stress for your team.' },
    ...
    venue: [
      ...
      { icon: '🏷️', label: 'My logo on the mirror screen', copy: 'The live display carries my venue branding. It looks like my event, powered by my stage.' },
    ...
    mirror: [
      { icon: '🏷️', label: 'My logo, all night long', copy: 'Upload my venue logo once. It appears on the big mirror screen the whole event — my branding, not Halli\'s.' },
    ...
    mirrorPreviewSub: 'The queue, the current track, crowd shout-outs — all updating in real time. This runs on any screen or TV in my venue.',
    mirrorPreviewLink: 'Open full screen ↗',
    ctaEyebrow: 'Ready to upgrade my venue events?',
    ctaHeading: 'Book The Human Jukebox for my next event',
  ...
  da: {
    ...
    how: [
      { icon: '📅', label: 'Du booker showet', copy: 'Én besked er alt, der skal til. Jeg møder op klar til at spille — intet udstyr, ingen stress for dit personale.' },
    ...
    venue: [
      ...
      { icon: '🏷️', label: 'Mit logo på spejlskærmen', copy: 'Live-displayet bærer min branding. Det ser ud som mit event, drevet af min scene.' },
    ...
    mirror: [
      { icon: '🏷️', label: 'Mit logo hele natten', copy: 'Upload mit logo én gang. Det vises på den store spejlskærm hele eventet — min branding, ikke Hallis.' },
    ...
    mirrorPreviewSub: 'Køen, den aktuelle sang, publikums beskeder — alt opdaterer i realtid. Kører på enhver skærm eller TV i mit spillested.',
    mirrorPreviewLink: 'Åbn fuld skærm ↗',
    ctaEyebrow: 'Klar til at opgradere mine events?',
    ctaHeading: 'Book The Human Jukebox til mit næste event',
