...
const COPY = {
  en: {
    ...
    venue: [
      ...
      { icon: '🍹', label: 'Promote the pub\'s drink offers', copy: 'Add a link to the pub\'s menu or tonight\'s specials. Every guest sees it right in the app — at the perfect moment.' },
      { icon: '🏷️', label: 'The pub\'s logo on the mirror screen', copy: 'The live display carries the pub\'s venue branding. It looks like the pub\'s event, powered by my stage.' },
  ...
  da: {
    ...
    venue: [
      ...
      { icon: '🍹', label: 'Fremvis pubens drinktilbud', copy: 'Tilføj et link til pubens menu eller aftenens tilbud. Alle gæster ser det direkte i appen — på det perfekte tidspunkt.' },
      { icon: '🏷️', label: 'Pubens logo på spejlskærmen', copy: 'Live-displayet bærer pubens branding. Det ser ud som pubens event, drevet af min scene.' },
