...
const COPY = {
  en: {
    eyebrow: '🎵 Live music experience for pubs',
    h1Line1: 'My guests pick the music.',
    h1Line2: 'My events get',
    h1Accent: 'unforgettable.',
    subtitle: 'The Human Jukebox lets the crowd request songs, sing along in karaoke mode, and vote the queue live — all on a shared screen my whole pub can see.',
    ...
    venueTitle: 'Why pubs choose The Human Jukebox',
    venue: [
      ...
      { icon: '📺', label: 'Live feed screen for the pub', copy: 'A dedicated display shows the live queue, now-playing track, and crowd activity — great on a bar TV.' },
      { icon: '🍹', label: 'Promote my drink offers', copy: 'Add a link to my menu or tonight\'s specials. Every guest sees it right in the app — at the perfect moment.' },
      { icon: '🏷️', label: 'My logo on the mirror screen', copy: 'The live display carries my pub branding. It looks like my event, powered by my stage.' },
      { icon: '🔁', label: 'Fresh every single event', copy: 'Every show is shaped by that crowd. No two events feel the same.' },
      { icon: '✅', label: 'Repeat bookings', copy: 'Guests come back specifically to request songs again. It becomes a pub signature.' },
    ],
    mirrorTitle: 'The mirror screen — my brand, front and centre',
    mirror: [
      { icon: '🏷️', label: 'My logo, all night long', copy: 'Upload my pub logo once. It appears on the big mirror screen the whole event — my branding, not Halli\'s.' },
    ...
    guestTitle: 'What my guests experience',
    guest: [
    ...
    mirrorPreviewEyebrow: '📺 This is what my bar TV shows all night',
    mirrorPreviewHeading: 'See the mirror screen live',
    mirrorPreviewSub: 'The queue, the current track, crowd shout-outs — all updating in real time. This runs on any screen or TV in my pub.',
    mirrorPreviewLink: 'Open full screen ↗',
    ctaEyebrow: 'Ready to upgrade my pub events?',
  ...
  da: {
    eyebrow: '🎵 Live musikoplevelse til pubber',
    h1Line1: 'Mine gæster vælger musikken.',
    h1Line2: 'Mine events bliver',
    h1Accent: 'uforglemmelige.',
    subtitle: 'The Human Jukebox lader publikum ønske sange, synge med i karaoke og stemme live — alt på en fælles skærm hele pubbens gæster kan se.',
    bookCta: '🎤 Book showet',
    demoCta: 'Prøv demo',
    stats: [
    ...
    venueTitle: 'Derfor vælger pubber The Human Jukebox',
    venue: [
      ...
      { icon: '📺', label: 'Live-skærm til pubbens bar', copy: 'Et dedikeret display viser den live-kø, aktuelle sang og publikumsaktivitet — perfekt på en bar-TV.' },
      { icon: '🍹', label: 'Fremvis mine drinktilbud', copy: 'Tilføj et link til min menu eller aftenens tilbud. Alle gæster ser det direkte i appen — på det perfekte tidspunkt.' },
      { icon: '🏷️', label: 'Mit logo på spejlskærmen', copy: 'Live-displayet bærer min pubs branding. Det ser ud som mit event, drevet af min scene.' },
      { icon: '🔁', label: 'Frisk for hvert eneste event', copy: 'Hvert show formes af netop det publikum. To events føles aldrig ens.' },
      { icon: '✅', label: 'Genbookinger', copy: 'Gæsterne kommer tilbage specifikt for at ønske sange igen. Det bliver pubbens varemærke.' },
    ],
    mirrorTitle: 'Spejlskærmen — min branding i centrum',
    mirror: [
      { icon: '🏷️', label: 'Mit logo hele natten', copy: 'Upload mit pubs logo én gang. Det vises på den store spejlskærm hele eventet — min branding, ikke Hallis.' },
    ...
    guestTitle: 'Hvad mine gæster oplever',
    guest: [
    ...
    mirrorPreviewEyebrow: '📺 Det her kører på min bar-TV hele natten',
    mirrorPreviewHeading: 'Se spejlskærmen live',
    mirrorPreviewSub: 'Køen, den aktuelle sang, publikums beskeder — alt opdaterer i realtid. Kører på enhver skærm eller TV i min pub.',
    mirrorPreviewLink: 'Åbn fuld skærm ↗',
    ctaEyebrow: 'Klar til at opgradere min pubs events?',
