...
function CreateGigPage() {
  ...
  const doCreate = async (includeDatetime: boolean) => {
    ...
    const createOptionsBase = {
      ...
      mirrorCountdownQrCustomUrl: mirrorCountdownQrCustomUrl.trim() || 'https://www.the-human-jukebox.org/audience',
      mirrorBreakQrEnabled: true,
      mirrorBreakQrCustomUrl: mirrorBreakQrCustomUrl.trim() || 'https://www.the-human-jukebox.org/audience',
      introAudioUrl,
