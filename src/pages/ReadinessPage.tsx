  ...
  return (
    <section className="admin-shell" aria-label="Host readiness dashboard">
      <section className="queue-panel admin-card readiness-panel">
        ...
        {/* Progress bar */}
        <div className="readiness-progress-bar-track" role="progressbar" aria-valuenow={progressPct} aria-valuemin={0} aria-valuemax={100}>
          <div
            className={`readiness-progress-bar-fill readiness-progress-bar-fill--${verdict}`}
