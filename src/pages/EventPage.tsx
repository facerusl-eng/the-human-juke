...
function EventPage() {
  ...
  const copy = audienceLocale === 'da'
    ? {
        ...
        onBreakCopy: 'Vi er lige på en kort pause. Gå til loungen og hold appen åben - vi er snart tilbage.',
    ...
    ? {
        ...
        onBreakTitle: 'On Break',
        onBreakCopy: 'Vid erum i stuttri pusu. Farðu i lounge og haltu appinu opnu - vid komum strax aftur.',
