...
export const DEMO_LIVE_INCOMING_POSTS: DemoFeedPost[] = [
  ...
  },
  {
    id: 'demo-live-003',
    event_id: 'demo-event-001',
    user_id: 'demo-live-u-003',
    author_name: 'Mikkel',
    message: 'Can we get Mr. Brightside up to #1? Everyone vote 🔥',
    image_data_url: null,
    created_at: '',
  },
  {
    id: 'demo-live-004',
    event_id: 'demo-event-001',
    user_id: 'demo-live-u-004',
    author_name: 'Freja',
    message: 'This crowd is unreal tonight, what a vibe ✨',
    image_data_url: null,
    created_at: '',
  },
  {
    id: 'demo-live-005',
    event_id: 'demo-event-001',
    user_id: 'demo-live-u-005',
    author_name: 'Jonas P.',
    message: 'Bartender of the year award goes to this place 🍻🏆',
    image_data_url: null,
    created_at: '',
  },
  {
    id: 'demo-live-006',
    event_id: 'demo-event-001',
    user_id: 'demo-live-u-006',
    author_name: 'Helena',
    message: 'Take On Me is such a banger. Zero notes. 🎶',
    image_data_url: null,
    created_at: '',
  },
  {
    id: 'demo-live-007',
    event_id: 'demo-event-001',
    user_id: 'demo-live-u-007',
    author_name: 'Nanna & Co',
    message: 'Table 4 says hi! We are singing every chorus 😂',
    image_data_url: null,
    created_at: '',
  },
  {
    id: 'demo-live-008',
    event_id: 'demo-event-001',
    user_id: 'demo-live-u-008',
    author_name: 'Viktor',
    message: 'Queue is looking stacked tonight, keep it coming!',
    image_data_url: null,
    created_at: '',
  },
  {
    id: 'demo-live-009',
    event_id: 'demo-event-001',
    user_id: 'demo-live-u-009',
    author_name: 'Lærke',
    message: 'Sweet Caroline got the whole room shouting 🤍',
    image_data_url: null,
    created_at: '',
  },
  {
    id: 'demo-live-010',
    event_id: 'demo-event-001',
    user_id: 'demo-live-u-010',
    author_name: 'Kasper',
    message: 'Can we pin this night forever? Absolute chaos in the best way.',
    image_data_url: null,
    created_at: '',
  },
]
